...
exports.createStudent = async (req, res) => {
  ...
  try {
    ...
    const userId = await generateId('USR', '"User"', 'user_id');       
    const studentId = await generateId('STU', 'Student', 'student_id'); 
    await pool.query(
    ...
    const result = await pool.query(
      ...
      [studentId, userId, first_name, last_name, phone, current_semester, program_id] 
    );
